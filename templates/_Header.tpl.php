...
<html lang="en">
	<head>
		...
		<meta name="description" content="Sige" />
			...
			<div class="navbar navbar-inverse navbar-fixed-top">
				<div class="navbar-inner">
					<div class="container">
						...
						<a class="brand" href="./">Sige</a>
						<div class="nav-collapse collapse">
							<ul class="nav">
								<?php if (isset($this->currentUser)) { ?>
								<li class="dropdown">
									<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-cogs"></i> Admin Usu&aacute;rios <i class="caret"></i></a>
								...
								<?php } ?>
								<li class="dropdown">
									<a href="#" class="dropdown-toggle" data-toggle="dropdown">		<i class="icon-user"></i> Cadastros <i class="caret"></i></a>
								<ul class="dropdown-menu">
									...
									<li <?php if ($this->nav=='justicas') { echo 'class="active"'; } ?>><a href="./justicas">Orgãos</a></li>
								</ul>
								<li <?php if ($this->nav=='agendas') { echo 'class="active"'; } ?>><a href="./agendas"><i class="icon-th"></i> Agendas</a></li>
								</li>
							</ul>
