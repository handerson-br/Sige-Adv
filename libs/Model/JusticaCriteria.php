...
require_once("DAO/JusticaCriteriaDAO.php");

/**
 * The JusticaCriteria class extends JusticaDAOCriteria and is used
 ...
 * @version 1.0
 */
class JusticaCriteria extends JusticaCriteriaDAO
{
