...
class ClienteController extends AppBaseController
{
	...
	public function Query()
	{
		try
		{
			...
			if ($filter) $criteria->AddFilter(
				new CriteriaFilter('Id,Nome,Sobrenome,Endereco,Cep,Estado,Cpf,Rg,Telefone,Email,Observacao'
				, '%'.$filter.'%')
			);
	...
	public function Create()
	{
		try
		{
			...
			$cliente->Sobrenome = $this->SafeGetVal($json, 'sobrenome');
			$cliente->Endereco = $this->SafeGetVal($json, 'endereco');
			$cliente->Cep = $this->SafeGetVal($json, 'cep');
			$cliente->Estado = $this->SafeGetVal($json, 'estado');
			$cliente->Cpf = $this->SafeGetVal($json, 'cpf');
			$cliente->Rg = $this->SafeGetVal($json, 'rg');
			$cliente->Telefone = $this->SafeGetVal($json, 'telefone');
			$cliente->Email = $this->SafeGetVal($json, 'email');
			$cliente->Observacao = $this->SafeGetVal($json, 'observacao');
	...
	public function Update()
	{
		try
		{
			...
			$cliente->Sobrenome = $this->SafeGetVal($json, 'sobrenome', $cliente->Sobrenome);
			$cliente->Endereco = $this->SafeGetVal($json, 'endereco', $cliente->Endereco);
			$cliente->Cep = $this->SafeGetVal($json, 'cep', $cliente->Cep);
			$cliente->Estado = $this->SafeGetVal($json, 'estado', $cliente->Estado);
			$cliente->Cpf = $this->SafeGetVal($json, 'cpf', $cliente->Cpf);
			$cliente->Rg = $this->SafeGetVal($json, 'rg', $cliente->Rg);
			$cliente->Telefone = $this->SafeGetVal($json, 'telefone', $cliente->Telefone);
			$cliente->Email = $this->SafeGetVal($json, 'email', $cliente->Email);
			$cliente->Observacao = $this->SafeGetVal($json, 'observacao', $cliente->Observacao);
