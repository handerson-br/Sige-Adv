...
GlobalConfig::$CONNECTION_SETTING->DBName = "u544985450_sige";
GlobalConfig::$CONNECTION_SETTING->Username = "u544985450_sige";
GlobalConfig::$CONNECTION_SETTING->Password = "sige@90";
...
/** the root url of the application with trailing slash, for example http://localhost/sige/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'sige/';
